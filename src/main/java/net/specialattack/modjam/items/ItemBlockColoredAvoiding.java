...
public class ItemBlockColoredAvoiding extends ItemBlock {
    ...
    public Icon getIconFromDamage(int meta) {
        return block.getIcon(2, BlockColored.getBlockFromDye(meta));
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean extra) {
        list.addAll(Minecraft.getMinecraft().fontRenderer.listFormattedStringToWidth(StatCollector.translateToLocal("item.avoiding.description"), 200));
    }
